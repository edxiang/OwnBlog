...
public class DiaryController {
    ...
    @RequestMapping(value = "/diary/changeSentence", method = RequestMethod.GET)
    @ResponseBody
    public String changeSentence(HttpServletRequest request){
        String s = request.getParameter("newSentence");
        return s;
    }
}
